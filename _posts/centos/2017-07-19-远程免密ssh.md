...
kent’s MacBook Pro:bin kentxxq$ ssh-copy-id root@192.168.0.222
...
# 测试是否正常使用
kent’s MacBook Pro:bin kentxxq$ ssh root@192.168.0.222
Last login: Tue Jul  4 20:57:34 2017 from 192.168.0.102
[root@centos1 ~]# 
```
